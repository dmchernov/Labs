...
namespace Izh_11_tasks.Task_2
{
    ...
    public static class BubbleSortClass
    {
        ...
        public delegate bool SortDirectionFunc(int a, int b);

        /// <summary>
        /// Сортирует строки матрицы согласно указанному типу и направлению сортировки.
        /// </summary>
        /// <param name="matrix">Исходная матрица.</param>
        /// <param name="sortType">Тип сортировки.</param>
        /// <param name="sortDirection">Делегат, задающий направление сортировки.</param>
        /// <returns>Матрица с отсортированными строками.</returns>
        public static int[,] Sort(int[,] matrix, SortType sortType, SortDirectionFunc sortDirection)
        {
            if (matrix == null)
            {
            ...
            for (int j = 1; j < matrix.GetLength(0); j++)
            {
                ...
                {
                    if (sortDirection(sortFunc(GetRow(matrix, i)), sortFunc(GetRow(matrix, i + 1))))
                    {
